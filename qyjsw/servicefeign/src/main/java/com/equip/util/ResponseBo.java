...
public class ResponseBo extends HashMap<String, Object> {
    ...
    private static final Integer LOCKED = 201;
    ...
    public static ResponseBo lock(Object msg) {
        ResponseBo responseBo = new ResponseBo();
        responseBo.put("code", LOCKED);
        responseBo.put("msg", msg);
        return responseBo;
    }

    public static ResponseBo warn(Object msg, Object data) {
        ResponseBo responseBo = new ResponseBo();
